...
Microbiology laboratory always reports day of blood culture positive in comment. We filtered common isolated organism. `r comment %>% filter(is.na(day_growth)) %>% count()` record(s) were not mentioned day of positive and excluded from analysis.
