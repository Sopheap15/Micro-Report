...
-   Ensure it has folder *data* and *output*
-   Adjust in dictionary for hospital, date to analyse, For end date, the default is 31-12-2021. It will automatic analyse based on the last date of column collection date in data.
